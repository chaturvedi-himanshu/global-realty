export const aboutPageDefaults = {
  heroBackgroundImage: "/images/slider/slider-1.jpg",
  heroVideo: "",
  statsBackgroundImage: "/images/slider/slider-1.jpg",
  statsOverlayColor: "rgba(31, 41, 55, 0.7)",
  ...
  heroStats: [
    ...
    { label: "Years experience", value: "39+" },
    { label: "Projects covered", value: "60k+" },
  ], 
  ...
  introHighlights: [
    { label: "98% satisfaction", note: "Based on past closures" },
    { label: "NCR • Delhi • Noida", note: "Pan-India reach" },
  ],
  storyTitle: "Real Estate Built on Relationships",
  storyParagraphs: [
    "At Buniyad Realty, we believe real estate is not just about property - it is about people, trust, and long-term relationships. Every interaction is rooted in understanding your goals, your challenges, and the future you are building.",
  ...
  leaders: [
    { name: "Kamal Batra", role: "CMD", image: "" },
    { name: "Abhi Batra", role: "Director", image: "" },
    { name: "Ansh Batra", role: "Director", image: "" },
  ],
...
export function mergeAboutPage(doc) {
  const source = doc && typeof doc === "object" ? doc : {};
  const output = { ...aboutPageDefaults };

  for (const key of Object.keys(aboutPageDefaults)) {
    const value = source[key];
    if (Array.isArray(aboutPageDefaults[key])) {
      if (Array.isArray(value) && value.length > 0) output[key] = value;
      continue;
    }
  ...
  output.isActive = source.isActive !== false;
  return output;
}
