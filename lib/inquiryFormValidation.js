 ...
 * @param {{ requireEmail?: boolean; requirePhone?: boolean; phoneMinDigits?: number; phoneMaxDigits?: number; requireInterest?: boolean; minInterest?: number; minMessage?: number; requireMessage?: boolean }} [opts]
 */
export function validateInquiryForm(fields, opts = {}) {
  ...
  const requireMessage = opts.requireMessage === true;
  ...
  if (requireEmail && !email) errors.email = "Please enter your email.";
